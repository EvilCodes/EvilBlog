...
<div class="js-sign-up-container">
  <form class="new_user" id="new_user" action="/users/register" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="lAKXAT5Dk4FCz+eEfOPg3bNOqstDE8+4B3ladQTbEs48vg6p7VoLgQo9anNUyW7Tb1Rz/0llFxl/bFmAJki9bA==" />
    ...
    <div class="input-prepend restyle no-radius security-up-code js-security-number hide">
      ...
      <a tabindex="-1" class="btn-up-resend js-send-code-button disable" href="javascript:void(0);">发送验证码</a>
