		...
		<script>
			$(document).ready(function() {
				$("#msg_btn").click(function() {
					...
					console.log("事件获得相应");
					console.log("号码是："+$("#user_mobile_number").val());
					$.post("./sendMsg",

						{
							msg_num: $("#user_mobile_number").val()
		...
		<div class="sign">
			...
			<div class="main">
				...
				<div class="js-sign-up-container">
					<form class="new_user" id="new_user" action="/users/register" accept-charset="UTF-8" method="post">
						<input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="lAKXAT5Dk4FCz+eEfOPg3bNOqstDE8+4B3ladQTbEs48vg6p7VoLgQo9anNUyW7Tb1Rz/0llFxl/bFmAJki9bA==" />
						<div class="input-prepend restyle">
							<input placeholder="你的昵称" type="text" value="" name="user[nickname]" id="user_nickname" /> <i class="iconfont ic-user"></i>
						</div>
						<div class="input-prepend restyle no-radius js-normal">
							<input type="hidden" value="CN" name="user[mobile_number_country_code]" id="user_mobile_number_country_code" /> <input placeholder="手机号" type="tel" name="user[mobile_number]" id="user_mobile_number" />
						...
						<div class="input-prepend restyle no-radius security-up-code js-security-number hide">
							<input type="text" name="sms_code" id="sms_code" placeholder="手机验证码" /> <i class="iconfont ic-verify"></i>

							</script>
							<!-- <a tabindex="-1" class="btn-up-resend js-send-code-button disable" href="">发送验证码</a> -->
							<a class="btn-up-resend js-send-code-button disable" id="msg_btn">发送验证码</a>
							<div class="js-geetest-captcha"></div>
						</div>
						<input type="hidden" name="security_number" id="security_number" />
						<div class="input-prepend">
							<input placeholder="设置密码" type="password" name="user[password]" id="user_password" /> <i class="iconfont ic-password"></i>
						</div>
					...
					<div class="more-sign">
						...
						<ul>
							<li>
								<a class="weibo" target="_blank" href="/users/auth/weibo"><i class="iconfont ic-weibo"></i></a>
							</li>
							<li>
								<a class="weixin" target="_blank" href="/users/auth/wechat"><i class="iconfont ic-wechat"></i></a>
							</li>
							<li>
								<a class="qq" target="_blank" href="/users/auth/qq_connect"><i class="iconfont ic-qq_connect"></i></a>
							</li>
						</ul>
