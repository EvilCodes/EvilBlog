(function() {
	var h = {},
		mt = {},
		c = {
			id: "0c0e9d9b1e7d617b3e6842e85b9fb068",
			dm: ["jianshu.com"],
	...
	mt.cookie.set = function(a, b, d) {
		...
		document.cookie = a + "=" + b + (d.domain ? "; domain=" + d.domain : "") + (d.path ? "; path=" + d.path : "") + (f ? "; expires=" + f.toGMTString() : "") + (d.hb ? "; secure" : "")
	};
	...
	(mt.h.Ea = function() {
		...
		(function() {
			if (!d)
				if (d = r, "complete" === document.readyState) a.A = r;
				else if (document.addEventListener) document.addEventListener("DOMContentLoaded",
				g, u), window.addEventListener("load", a, u);
		...
		return function(d) {
			switch (typeof d) {
				...
				default:
					...
					p = mt.l.stringify;
					for (n in d)
						if (Object.prototype.hasOwnProperty.call(d, n)) switch (e =
							d[n], typeof e) {
							case "undefined":
							case "unknown":
							case "function":
	...
	var A = h.na;
	h.D = {
		bb: "http://tongji.baidu.com/hm-web/welcome/ico",
		$: "hm.baidu.com/hm.gif",
		ea: "baidu.com",
		ya: "hmmd",
		za: "hmpl",
		...
		Sa: 1,
		P: 2147483647,
		ba: "cc cf ci ck cl cm cp cu cw ds vl ep et fl ja ln lo lt rnd si su v cv lv api sn ct u tt".split(" ")
	};
	(function() {
		var a = {
			p: {},
	...
	(function() {
		function a(a, d, m, b) {
			if (!(a === q || d === q || b === q)) {
				...
				a = String(a).split("!");
				for (var e, v = u, x = 0; x < a.length; x++)
					if (e = a[x].split("*"), String(d) === e[0]) {
						e[1] = m;
						e[2] = b;
						a[x] = e.join("*");
						v = r;
		...
		var d = mt.lang,
			...
			e = {
				...
				ma: function() {
					if (0 < e.s.length)
						for (var a = 0, d = e.s.length; a < d; a++) e.Q(e.s[a]);
					e.s = t
				},
				Q: function(a) {
					var b = a[0];
				...
				_trackEvent: function(a) {
					2 <
						a.length && (e.e |= 8, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 4, h.b.a.ep = d.j(a[1]) + "*" + d.j(a[2]) + (a[3] ? "*" + d.j(a[3]) : "") + (a[4] ? "*" + d.j(a[4]) : ""), h.b.k())
				},
				_setCustomVar: function(a) {
					if (!(4 > a.length)) {
						...
						if (0 < b && 6 > b && 0 < m && 4 > m) {
							...
							"" !== a ? h.b.setData("Hm_cv_" + c.id, encodeURIComponent(a), c.age) : h.b.Fa("Hm_cv_" +
								c.id)
						}
					}
				},
				...
				_setReferrerOverride: function(a) {
					1 <
						a.length && (h.b.a.su = a[1].charAt && "/" === a[1].charAt(0) ? n.protocol + "//" + window.location.host + a[1] : a[1], e.Y = r)
				},
				...
				_trackRTEvent: function(a) {
					...
					if (d.d(a, "Object")) {
						...
						if (900 >= m) g.call(this, a);
							...
							for (var m = Math.ceil(m / 900), s = "block|" + Math.round(Math.random() * n.P).toString(16) + "|" + m + "|", l = [], v = 0; v < m; v++) l.push(v), l.push(a.substring(900 * v, 900 * v + 900)), g.call(this, s + l.join("|")), l = []
					}
				},
	...
	(function() {
		function a() {
			"undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = r, this.a = {}, this.X = r, this.M = u, this.init())
		}
		var b = mt.url,
			d = mt.aa,
			f = mt.S,
		...
		a.prototype = {
			...
			I: function() {
				for (var a = document.location.hostname, b = 0, d = c.dm.length; b < d; b++)
					if (this.N(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[\/\?#].*/, "");
				return a
			},
			V: function() {
			...
			init: function() {
				try {
					this.La(), 0 === this.a.nv ? this.Ia() : this.R(".*"), h.b = this, this.ga(), w.w("pv-b"), this.Ha()
				} catch (a) {
					var b = [];
					b.push("si=" + c.id);
			...
			ga: function() {
				var a = document.location.hash.substring(1),
					d = RegExp(c.id),
					e = -1 < document.referrer.indexOf(k.ea),
					f = b.i(a, "jn"),
	...
	(function() {
		...
		if ("undefined" !== typeof h.b && (c.med || (!a.Da || 7 < a.Ba) && c.cvcc)) {
			...
			if (c.med) n = "/zoosnet", g = "swt", l = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i, p = {
				...
				p = {
					click: function() {
						for (var a = [], b = e(document.getElementsByTagName("a")), b = [].concat.apply(b, e(document.getElementsByTagName("area"))), b = [].concat.apply(b, e(document.getElementsByTagName("img"))), d, f, g, k = 0, n = b.length; k < n; k++) d = b[k], l !== q ? (f = d.getAttribute("onclick"), g = d.getAttribute("href"), m ? (d = d.getAttribute("id"), (l.test(f) || l.test(g) || m.test(d)) &&
							a.push(b[k])) : (l.test(f) || l.test(g)) && a.push(b[k])) : m !== q && (d = d.getAttribute("id"), m.test(d) && a.push(b[k]));
						return a
					}
				}
			}
			if ("undefined" !== typeof p && "undefined" !== typeof l) {
				...
				var y = function(a, d) {
					...
					if (b.d(d, "Array") || b.d(d, "NodeList"))
						for (var e = 0, f = d.length; e < f; e++)
							if (s === d[e]) return w(n + a + "/" + (e + 1), d[e]), u
				};
				d.c(document, "mousedown", function(a) {
					...
					for (k(p, function(a, e) {
						...
						s !== document && k(d, y) !== u;) s = s.parentNode
				})
			}
		}
	})();
