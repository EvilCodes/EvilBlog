...
<html>
	...
	<head>
		...
		<meta name="csrf-token" content="dLudMIFtkLCx+RYgKWL88D9TiW3a4XVOD7WXAf/icy6eCaMnxvu8HvNIYsfVU73EL+k6YxvETM20UutcXJSi5Q==">
  ...
  <div class="normal-title">
    ...
    <a id="js-sign-up-btn" class="" href="./sign_up">注册</a>
				...
				<div class="js-sign-in-container">
					<form id="new_session" action="/sessions" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="dLudMIFtkLCx+RYgKWL88D9TiW3a4XVOD7WXAf/icy6eCaMnxvu8HvNIYsfVU73EL+k6YxvETM20UutcXJSi5Q==">
						...
						<div>
							<div class="captcha"><input name="captcha[validation][challenge]" autocomplete="off" type="hidden" value="8f90c18251de123fbefa7c330e75d24f"> <input name="captcha[validation][gt]" autocomplete="off" type="hidden" value="ec47641997d5292180681a247db3c92e"> <input name="captcha[validation][validate]"
									autocomplete="off" type="hidden" value=""> <input name="captcha[validation][seccode]" autocomplete="off" type="hidden" value=""> <input name="captcha[id]" autocomplete="off" type="hidden" value="">
								<div id="geetest-area" class="geetest">
									<!-- <div class="geetest_holder geetest_wind geetest_detect" style="width: 300px;">
										...
										<div class="geetest_btn">
											<div class="geetest_radar_btn">
												<div class="geetest_radar">
													...
													<div class="geetest_sector" style="transform: rotate(77.9275deg);">
														<div class="geetest_small"></div>
													</div>
												...
												<div class="geetest_radar_tip"><span class="geetest_radar_tip_content">点击按钮进行验证</span><span class="geetest_reset_tip_content">请点击重试</span><span class="geetest_radar_error_code"></span></div>
											...
											<div class="geetest_ghost_success">
												<div class="geetest_success_btn">
													...
													<div class="geetest_success_radar_tip"><span class="geetest_success_radar_tip_content"></span></div>
										...
										<div class="geetest_wait"><span class="geetest_wait_dot geetest_dot_1"></span><span class="geetest_wait_dot geetest_dot_2"></span><span class="geetest_wait_dot geetest_dot_3"></span></div>
  ...
  ================================================== -->
		...
		<script src="./js/web-base-fcf22328f0e4b2793730.js" crossorigin="anonymous"></script>
