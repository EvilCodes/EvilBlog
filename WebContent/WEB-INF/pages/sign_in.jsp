...
<meta name="mobile-agent"
	content="format=html5;url=http://www.jianshu.com/sign_in">
			...
			<div class="js-sign-in-container">
				<form id="new_session" 	action="./login.do" accept-charset="UTF-8"
					...
					<input name="utf8" type="hidden" value="✓"><input
						...
						value="dLudMIFtkLCx+RYgKWL88D9TiW3a4XVOD7WXAf/icy6eCaMnxvu8HvNIYsfVU73EL+k6YxvETM20UutcXJSi5Q==">
					...
					<div>
						<div class="captcha">
							<input name="captcha[validation][challenge]" autocomplete="off"
								type="hidden" value="8f90c18251de123fbefa7c330e75d24f">
							<input name="captcha[validation][gt]" autocomplete="off"
								type="hidden" value="ec47641997d5292180681a247db3c92e">
							<input name="captcha[validation][validate]" autocomplete="off"
								type="hidden" value=""> <input
								name="captcha[validation][seccode]" autocomplete="off"
								type="hidden" value=""> <input name="captcha[id]"
				...
				<div class="more-sign">
					...
					<ul>
						...
						<li><a class="weixin" target="_blank"
							href="/users/auth/wechat"><i class="iconfont ic-wechat"></i></a></li>
						<li><a class="qq" target="_blank"
							href="/users/auth/qq_connect"><i
								class="iconfont ic-qq_connect"></i></a></li>
						<li class="js-more-method"><a href="javascript:void(0);"><i
								class="iconfont ic-more"></i></a></li>
