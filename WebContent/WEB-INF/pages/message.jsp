...
<meta name="mobile-agent"
	content="format=html5;url=http://www.jianshu.com/notifications">
			...
			<div class="collapse navbar-collapse" id="menu">
				<ul class="nav navbar-nav">
					...
					<li class="tab notification v-notification-dropdown-menu active">
						<a class="notification-btn" href="/notifications"
					...
					<li class="search">
						<form target="_blank" action="/search" accept-charset="UTF-8"
							...
							<input name="utf8" type="hidden" value="&#x2713;" /> <input
								...
								placeholder="搜索" class="search-input" /> <a class="search-btn"
								href="javascript:void(null)"><i class="iconfont ic-search"></i></a>
						</form>
					</li>
				</ul>
			</div>
